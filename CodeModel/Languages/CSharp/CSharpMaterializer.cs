...
{
    public class CSharpMaterializer:Materializer
    {
        public new CSharpLanguage Language { get { return base.Language as CSharpLanguage; } }

        public CSharpMaterializer(CSharpLanguage Language) 
        {
